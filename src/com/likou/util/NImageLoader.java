 ...
 */
public class NImageLoader extends com.android.volley.toolbox.ImageLoader {
	private static final ColorDrawable transparentDrawable = new ColorDrawable(
			android.R.color.transparent);
	private static final int HALF_FADE_IN_TIME = 250 / 2;
	 ...
	 */
	public NImageLoader(FragmentActivity activity) {
	 ...
	 */
	public NImageLoader(FragmentActivity activity, int defaultPlaceHolderResId) {
		super(newRequestQueue(activity), BitmapCache.getInstance(activity
				.getSupportFragmentManager()));
		mResources = activity.getResources();
	...
	public NImageLoader setFadeInImage(boolean fadeInImage) {
		mFadeInImage = fadeInImage;
		return this;
	}

	public NImageLoader setMaxImageSize(int maxImageWidth, int maxImageHeight) {
		mMaxImageWidth = maxImageWidth;
		mMaxImageHeight = maxImageHeight;
		return this;
	}

	public NImageLoader setMaxImageSize(int maxImageSize) {
	...
	private static RequestQueue newRequestQueue(Context context) {
		...
		Network network = new BasicNetwork(new HttpClientStack(AndroidHttpClient.newInstance(NetUtils
...
//		} else 
	...
	public interface ImageLoaderProvider {
		public NImageLoader getImageLoaderInstance();
	}
